...
def draw(dataset, model, alpha, f):
    local_acc = torch.load('runs/exp/local/fmnist_lenet_100_iidFalse_0.5_user100_Nov.19_01.15.54/local_train_epoch_acc')
    local_acc = local_acc['local_acc'][:, -1]
    ...
    fig, axs2d = plt.subplots(1, 1, figsize=(10, 5))
    axs = [axs2d]
